...
class ResultSetTooLargeError(Exception):
    ...
    def __init__(self, result_set_id: str, size: int, limit: int):
        ...
        super().__init__(
            ...
            f"Zawęź zestaw przy wyszukiwaniu: parametr limit={limit} w "
            f"search_legal_acts, browse_acts lub track_legal_changes, węższe "
            f"kryteria, a dla track_legal_changes także węższy zakres "
            f"date_from/date_to lub keywords. Wynik częściowy nie jest "
